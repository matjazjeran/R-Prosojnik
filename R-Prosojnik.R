...
# Program lahko s spremembami zacetnih nastavitev prilagodimo za poljubno
# razpoko na obzorju in poljubno stojisce fotografa
# ter poljuben datum
#
...
points (alt ~ azi, data = tmp, cex = 0.8, col = "orange")

# add comment for best date and time of observation
text (x = 168, y = 23.5, labels = paste (txt.opttime, opt.time), pos = 4)
